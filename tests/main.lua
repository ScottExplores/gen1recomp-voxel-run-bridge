...
eq(pokemonFinal.lib._voxelRunBridgeHook.version, "0.10.1",
...
eq(buggyCacheScreen._scottsTweaksCacheStartHook.version, "0.10.1",
...
eq(manifest:match('"version"%s*:%s*"([^"]+)"'), "0.10.1",
