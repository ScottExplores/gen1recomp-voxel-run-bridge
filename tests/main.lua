...
eq(pokemonFinal.lib._voxelRunBridgeHook.version, "0.12.3",
...
eq(buggyCacheScreen._scottsTweaksCacheStartHook.version, "0.12.3",
...
eq(manifest:match('"version"%s*:%s*"([^"]+)"'), "0.12.3",
