...
eq(pokemonFinal.lib._voxelRunBridgeHook.version, "0.10.0",
...
eq(buggyCacheScreen._scottsTweaksCacheStartHook.version, "0.10.0",
...
eq(manifest:match('"version"%s*:%s*"([^"]+)"'), "0.10.0",
