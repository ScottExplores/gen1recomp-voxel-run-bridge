...
T.eq(run.mod and run.mod.manifest.version, "0.9.1",
  "loader selected version 0.9.1")
-- 0.9.1 bundles All Pokemon Catchable 151 and Dynamic Scaling, which repatch
...
T.eq(pokemonFinalExports.lib._voxelRunBridgeHook.version, "0.9.1",
