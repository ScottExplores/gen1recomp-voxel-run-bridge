...
T.eq(run.mod and run.mod.manifest.version, "0.9.0",
  "loader selected version 0.9.0")
-- 0.9.0 bundles All Pokemon Catchable 151 and Dynamic Scaling, which repatch
...
T.eq(pokemonFinalExports.lib._voxelRunBridgeHook.version, "0.9.0",
