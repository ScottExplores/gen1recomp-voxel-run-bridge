...
return {
  ...
  -- placement.
  -- Tiles that belong only on a building's FRONT: doorways, hanging shop
  -- signs, and painted GYM lettering.  lib/Buildings.lua and the fallback
  -- volume path in lib/ChunkMesher.lua substitute neighbouring plain wall
  -- art on rear/flank faces so these details are never mirrored onto a
  -- non-enterable back wall.  Windows are intentionally not listed.
  frontOnly = {
    -- doorway 11/12 over 27/28; POKe 66/67 and MART 68/69 signs over
    -- bracket row 74; GYM lettering 47/63.
    OVERWORLD = { 11, 12, 27, 28, 47, 63, 66, 67, 68, 69, 74 },
    -- Indigo Plateau and Victory Road doorway block.
    PLATEAU = { 11, 12, 27, 28 },
    -- Safari Zone gate's double door.
    FOREST = { 42, 43, 58, 59 },
  },
