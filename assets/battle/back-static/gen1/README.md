# Generation 1 static back sprites

These 151 back sprites are the **International Yellow (Game Boy Color) back
sprites** ripped from Pokémon Yellow (international release, GBC).

Source: [International Yellow back sprites (Game Boy Color) — Bulbagarden
Archives](https://archives.bulbagarden.net/wiki/Category:International_Yellow_back_sprites_(Game_Boy_Color))
...
`Spr_b_1y_001.png` … `Spr_b_1y_151.png`, and renamed to the lowercase species
