...
local SENTINELS = {
  ...
  { path = "vendor/modern_bag_ui/main.lua", what = "Modern Bag UI" },
  { path = "vendor/modern_bag_ui/screen.lua", what = "Modern Bag UI Bag/PC renderer" },
  { path = "vendor/modern_bag_ui/inventory.lua", what = "Modern Bag UI PC integration" },
  { path = "vendor/modern_bag_ui/LICENSE", what = "Modern Bag UI MIT notice" },
